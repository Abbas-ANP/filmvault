const MovieCard = ({ movie, poster, title, handleWatchList }) => {
  return (
    <div
    ...
    >
      <div onClick={() => handleWatchList(movie)} className="bg-black bg-opacity-60 p-1 rounded-xl absolute top-2 right-2">&#128525;</div>
